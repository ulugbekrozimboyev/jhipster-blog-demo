...
export class Tag extends React.Component<ITagProps, ITagState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="tag-heading">
          <Translate contentKey="blogDemoApp.tag.home.title">Tags</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="blogDemoApp.tag.home.createLabel">Create new Tag</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="blogDemoApp.tag.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
