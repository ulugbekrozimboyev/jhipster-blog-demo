    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="blogDemoApp.tag.home.createOrEditLabel">
              <Translate contentKey="blogDemoApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : tagEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="tag-name">
                    <Translate contentKey="blogDemoApp.tag.name">Name</Translate>
                  </Label>
