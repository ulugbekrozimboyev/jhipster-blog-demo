...
import uz.blog.service.TagService;
import uz.blog.web.rest.errors.BadRequestAlertException;
import uz.blog.service.dto.TagDTO;
...
/**
 * REST controller for managing {@link uz.blog.domain.Tag}.
 */
@RestController
@RequestMapping("/api")
public class TagResource {
     ...
     */
    @GetMapping("/tags")
    public ResponseEntity<List<TagDTO>> getAllTags(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
